...
const store: Notification[] = [
  // Legal Manager (u-lm) — Tyson Yapao
  {
    ...
    body: 'CASE-2026-001 "Sepik Securities licence suspension appeal" has been assigned to you.',
    entityType: 'case',
    entityId: 'case-1',
    linkTo: '/cases/case-1',
    read: false,
  ...
  },
  {
    ...
    body: 'DOC-2026-008 "Board Delegation Note" was uploaded and linked to CASE-2026-008.',
    entityType: 'document',
    entityId: 'doc-8',
  ...
  },
  {
    ...
    body: 'CASE-2026-005 "Madang Growth revocation litigation" moved to Open.',
    entityType: 'case',
    entityId: 'case-5',
    linkTo: '/cases/case-5',
    read: false,
  ...
  // Senior Legal Officer (u-sr) — Isaac Mel
  {
    ...
    type: 'case_assigned',
    title: 'Case assigned to you',
    body: 'CASE-2026-003 "Employment disciplinary review" has been assigned to you.',
    entityType: 'case',
    entityId: 'case-3',
    linkTo: '/cases/case-3',
    read: false,
  ...
  // Legal Officer (u-lo1) — Immanuel Minoga
  {
    ...
    type: 'case_assigned',
    title: 'Case assigned to you',
    body: 'CASE-2026-004 "PNG Infrastructure Notes prospectus review" has been assigned to you.',
    entityType: 'case',
    entityId: 'case-4',
    linkTo: '/cases/case-4',
    read: false,
  ...
  // Executive Officer (u-eo) — Ninipe Gurumo
  {
    ...
    body: 'CASE-2026-012 "New Guinea Energy continuous disclosure matter" has been opened.',
    entityType: 'case',
    entityId: 'case-12',
  ...
  // CEO (u-ceo) — James Joshua
  {
    ...
    type: 'case_status_changed',
    title: 'Case status updated',
    body: 'CASE-2026-001 "Sepik Securities licence suspension appeal" is now Under Review.',
    entityType: 'case',
    entityId: 'case-1',
    linkTo: '/cases/case-1',
    read: false,
