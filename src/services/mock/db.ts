...
export const users: User[] = [
  ...
  { id: 'u-eo', name: 'Executive Officer (Vacant — pending confirmation)', role: 'Executive Officer' },
...
export const db: {
  ...
  cases: [
    { id: 'case-1',  caseNumber: 'MATT-2026-001', caseTitle: 'Sepik Securities licence suspension appeal',        entityId: 'ENT-003', caseDivision: 'Enforcement & Compliance', caseSubType: 'Compliance',              description: 'Review of suspension appeal and remediation undertakings.',                                            responsibleOfficerId: 'u-lm',  status: 'Pending Closure', dateOpened: '2026-01-13', dateClosed: null,         confidentiality: 'Restricted',            confidentialClass: null,                          closureInitiatedBy: 'u-lm', closureApprovedBy: null, closureApprovedAt: null, createdAt: now(), updatedAt: now() },
    { id: 'case-2',  caseNumber: 'MATT-2026-002', caseTitle: 'Kumul Capital market manipulation inquiry',          entityId: 'ENT-001', caseDivision: 'Enforcement & Compliance', caseSubType: 'Compliance',              description: 'Legal support for investigation into unusual trade activity.',                                         responsibleOfficerId: 'u-gc',  status: 'Open',            dateOpened: '2026-02-04', dateClosed: null,         confidentiality: 'Confidential',          confidentialClass: 'Regulatory Investigations',   grantedUserIds: ['u-lm'], isHighRisk: true, highRiskSetBy: 'u-gc', highRiskSetAt: '2026-02-10', createdAt: now(), updatedAt: now() },
    { id: 'case-3',  caseNumber: 'MATT-2026-003', caseTitle: 'Employment disciplinary review',                     entityId: 'ENT-012', caseDivision: 'Legal Advisory',           caseSubType: 'In-house legal advice',   description: 'Advice on staff disciplinary matter involving privileged records.',                                    responsibleOfficerId: 'u-sr',  status: 'Pending',         dateOpened: '2026-02-18', dateClosed: null,         confidentiality: 'Confidential',          confidentialClass: 'Employment Disciplinary Cases',                             createdAt: now(), updatedAt: now() },
    { id: 'case-4',  caseNumber: 'MATT-2026-004', caseTitle: 'PNG Infrastructure Notes prospectus review',         entityId: 'ENT-009', caseDivision: 'Legal Advisory',           caseSubType: 'Contracts',               description: 'Prospectus and note deed legal review.',                                                               responsibleOfficerId: 'u-lo1', status: 'Open',            dateOpened: '2026-03-01', dateClosed: null,         confidentiality: 'Restricted',            confidentialClass: null,                                                          createdAt: now(), updatedAt: now() },
    { id: 'case-5',  caseNumber: 'MATT-2026-005', caseTitle: 'Madang Growth revocation litigation',                entityId: 'ENT-010', caseDivision: 'Enforcement & Compliance', caseSubType: 'Litigation',              description: 'Court challenge to licence revocation.',                                                               responsibleOfficerId: 'u-gc',  status: 'Open',            dateOpened: '2026-03-09', dateClosed: null,         confidentiality: 'Confidential',          confidentialClass: 'Litigation Matters',          isHighRisk: true, highRiskSetBy: 'u-gc', highRiskSetAt: '2026-03-15', createdAt: now(), updatedAt: now() },
    { id: 'case-6',  caseNumber: 'MATT-2026-006', caseTitle: 'Bougainville Exchange listing rules advice',         entityId: 'ENT-007', caseDivision: 'Enforcement & Compliance', caseSubType: 'Compliance',              description: 'Advice on listing rule harmonisation.',                                                                responsibleOfficerId: 'u-lo2', status: 'Draft',           dateOpened: '2026-03-22', dateClosed: null,         confidentiality: 'Restricted',            confidentialClass: null,                                                          createdAt: now(), updatedAt: now() },
    { id: 'case-7',  caseNumber: 'MATT-2026-007', caseTitle: 'Pacific Balanced Fund deed amendment',               entityId: 'ENT-002', caseDivision: 'Legal Advisory',           caseSubType: 'Contracts',               description: 'Review trust deed amendment and investor notices.',                                                    responsibleOfficerId: 'u-lo1', status: 'Closed',          dateOpened: '2026-01-30', dateClosed: '2026-04-12', confidentiality: 'Restricted',            confidentialClass: null,                                                          createdAt: now(), updatedAt: now() },
    { id: 'case-8',  caseNumber: 'MATT-2026-008', caseTitle: 'Board delegation instrument update',                 entityId: 'ENT-006', caseDivision: 'Executive & Secretariat',  caseSubType: 'Board/executive matters', description: 'Confidential advice on board delegation instrument and CEO authorisation scope.',                       responsibleOfficerId: 'u-lm',  status: 'Pending',         dateOpened: '2026-04-08', dateClosed: null,         confidentiality: 'Executive Confidential', confidentialClass: 'Board Matters',                                               createdAt: now(), updatedAt: now() },
    { id: 'case-9',  caseNumber: 'MATT-2026-009', caseTitle: 'Motuan Asset adviser agreement',                     entityId: 'ENT-008', caseDivision: 'Legal Advisory',           caseSubType: 'Contracts',               description: 'Standard adviser agreement revision.',                                                                 responsibleOfficerId: 'u-lo3', status: 'Open',            dateOpened: '2026-04-21', dateClosed: null,         confidentiality: 'Restricted',            confidentialClass: null,                                                          createdAt: now(), updatedAt: now() },
    { id: 'case-10', caseNumber: 'MATT-2026-010', caseTitle: 'National Capital custody compliance notice',         entityId: 'ENT-011', caseDivision: 'Enforcement & Compliance', caseSubType: 'Compliance',              description: 'Draft compliance notice and enforcement options.',                                                      responsibleOfficerId: 'u-sr',  status: 'Under Review',   dateOpened: '2026-05-03', dateClosed: null,         confidentiality: 'Restricted',            confidentialClass: null,                                                          createdAt: now(), updatedAt: now() },
    { id: 'case-11', caseNumber: 'MATT-2026-011', caseTitle: 'Highlands trustee application conditions',           entityId: 'ENT-005', caseDivision: 'Enforcement & Compliance', caseSubType: 'Compliance',              description: 'Licence condition drafting for trustee application.',                                                   responsibleOfficerId: 'u-lo2', status: 'Open',            dateOpened: '2026-05-20', dateClosed: null,         confidentiality: 'Public',                confidentialClass: null,                                                          createdAt: now(), updatedAt: now() },
    { id: 'case-12', caseNumber: 'MATT-2026-012', caseTitle: 'New Guinea Energy continuous disclosure matter',     entityId: 'ENT-004', caseDivision: 'Enforcement & Compliance', caseSubType: 'Compliance',              description: 'Continuous disclosure advice and CEO brief.',                                                           responsibleOfficerId: 'u-sr',  status: 'Open',            dateOpened: '2026-06-01', dateClosed: null,         confidentiality: 'Public',                confidentialClass: null,                                                          createdAt: now(), updatedAt: now() },
    { id: 'case-13', caseNumber: 'MATT-2026-013', caseTitle: 'Staff disciplinary matter — procurement irregularity', entityId: null,    caseDivision: 'Legal Advisory',           caseSubType: 'In-house legal advice',   description: 'Internal HR matter involving a staff member and procurement process. No regulated entity involved.',   responsibleOfficerId: 'u-lm',  status: 'Open',            dateOpened: '2026-06-20', dateClosed: null,         confidentiality: 'Confidential',          confidentialClass: 'Employment Disciplinary Cases',                             createdAt: now(), updatedAt: now() },
  ],
  documents: [],
  correspondence: [],
  notes: [
  ...
  counters: { case: 13, document: 28, correspondence: 10, entity: 12 },
};
...
// Seed templates — not linked to any matter; isTemplate: true keeps them out of matter document lists
db.documents.push(
  { id: 'tmpl-1', documentNumber: 'TMPL-001', title: 'Standard Suspension Notice', category: 'Compliance Documents', currentVersion: 2, versions: [{ version: 1, fileName: 'suspension-notice-v1.docx', updatedBy: 'Andy Ambulu', updatedAt: '2026-01-10', note: 'Initial template' }, { version: 2, fileName: 'suspension-notice-v2.docx', updatedBy: 'Tyson Yapao', updatedAt: '2026-04-01', note: 'Updated to reflect 2026 regulatory form' }], entityId: null, caseId: null, correspondenceId: null, uploadedBy: 'u-gc', uploadDate: '2026-01-10', status: 'Active', isConfidential: false, classification: 'Public', isTemplate: true, templateType: 'Standard Notice' },
  { id: 'tmpl-2', documentNumber: 'TMPL-002', title: 'WSP Form A — Licence Application', category: 'Compliance Documents', currentVersion: 1, versions: [{ version: 1, fileName: 'wsp-form-a.pdf', updatedBy: 'Isaac Mel', updatedAt: '2026-02-15', note: 'Current approved form' }], entityId: null, caseId: null, correspondenceId: null, uploadedBy: 'u-sr', uploadDate: '2026-02-15', status: 'Active', isConfidential: false, classification: 'Public', isTemplate: true, templateType: 'WSP Form' },
  { id: 'tmpl-3', documentNumber: 'TMPL-003', title: 'Adviser Agreement Precedent', category: 'Contracts', currentVersion: 1, versions: [{ version: 1, fileName: 'adviser-agreement-precedent.docx', updatedBy: 'Andy Ambulu', updatedAt: '2026-03-05', note: 'Standard form adviser agreement' }], entityId: null, caseId: null, correspondenceId: null, uploadedBy: 'u-gc', uploadDate: '2026-03-05', status: 'Active', isConfidential: false, classification: 'Restricted', isTemplate: true, templateType: 'Contract Precedent' },
  { id: 'tmpl-4', documentNumber: 'TMPL-004', title: 'Show Cause Letter — Compliance Breach', category: 'External Correspondence', currentVersion: 1, versions: [{ version: 1, fileName: 'show-cause-letter.docx', updatedBy: 'Tyson Yapao', updatedAt: '2026-05-20', note: 'Standard show cause letter for enforcement use' }], entityId: null, caseId: null, correspondenceId: null, uploadedBy: 'u-lm', uploadDate: '2026-05-20', status: 'Active', isConfidential: false, classification: 'Public', isTemplate: true, templateType: 'Letter Template' },
);
...
db.correspondence = [
  ...
  { id: 'corr-3', correspondenceNumber: 'COR-2026-003', subject: 'Prospectus clarification request', direction: 'Incoming', date: '2026-03-18', sender: 'PNG Infrastructure Notes PLC', recipient: 'SCPNG CEO', category: 'Regulatory Communications', priority: 'Medium', confidentiality: 'Restricted', assignedTo: ['Senior Legal Officer'], actionRequired: 'Review', dueDate: '2026-04-01', responseReference: null, entityId: 'ENT-009', caseId: 'case-4', attachments: ['doc-4'], status: 'Under Review' },
  ...
  { id: 'corr-6', correspondenceNumber: 'COR-2026-006', subject: 'Custody compliance notice dispatch', direction: 'Outgoing', date: '2026-05-11', sender: 'SCPNG CEO', recipient: 'National Capital Custodians', category: 'Regulatory Communications', priority: 'Medium', confidentiality: 'Restricted', assignedTo: ['Legal Manager'], actionRequired: 'Information Only', dueDate: null, responseReference: null, entityId: 'ENT-011', caseId: 'case-10', attachments: ['doc-10'], status: 'Closed', closedDate: '2026-05-19', approvedBy: 'u-ceo', approvedAt: '2026-05-12', isLegalMatter: false },
  { id: 'corr-7', correspondenceNumber: 'COR-2026-007', subject: 'Trustee conditions consultation', direction: 'Outgoing', date: '2026-05-26', sender: 'SCPNG Legal', recipient: 'Highlands Trustees & Custody', category: 'Stakeholder Letters', priority: 'Medium', confidentiality: 'Restricted', assignedTo: ['Senior Legal Officer'], actionRequired: 'Response', dueDate: '2026-06-10', responseReference: null, entityId: 'ENT-005', caseId: 'case-11', attachments: [], status: 'Open', isLegalMatter: false },
  ...
  { id: 'corr-9', correspondenceNumber: 'COR-2026-009', subject: 'Adviser agreement confirmation', direction: 'Outgoing', date: '2026-06-08', sender: 'SCPNG Legal', recipient: 'Motuan Asset Advisors', category: 'Stakeholder Letters', priority: 'Low', confidentiality: 'Restricted', assignedTo: ['Legal Officer'], actionRequired: 'Information Only', dueDate: null, responseReference: 'COR-2026-007', entityId: 'ENT-008', caseId: 'case-9', attachments: ['doc-9'], status: 'Responded', closedDate: '2026-06-13', isLegalMatter: false },
  { id: 'corr-10', correspondenceNumber: 'COR-2026-010', subject: 'Madang revocation — General Counsel sign-off notice', direction: 'Outgoing', date: '2026-06-18', sender: 'SCPNG General Counsel', recipient: 'Madang Growth Equities', category: 'Regulatory Communications', priority: 'Critical', confidentiality: 'Confidential', assignedTo: ['General Counsel'], actionRequired: 'Approval', dueDate: '2026-06-25', responseReference: null, entityId: 'ENT-010', caseId: 'case-5', attachments: [], status: 'In Progress', isLegalMatter: true },
];
